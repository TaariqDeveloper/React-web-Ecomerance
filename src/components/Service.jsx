...
//   return (
//     <div>
//       <div className="flex mx-40 gap-20 w-[400px] mt-8 mb-20">
//         {images.map((ser, index) => (
//           <img key={index} src={ser.image} alt={`Service ${index}`} />
//         ))}
//       </div>
//       <div>
//         <h1 className="text-center text-3xl text-black font-semibold underline pb-20">
//           Featured Products
//         </h1>
